...
function ensureHeadingId(
  ...
  const candidateId =
    heading.id || existingGeneratedId || createHeadingId(text, usedIds)
...
export function setupToc(
  ...
  const {
    topOffset = 96,
    headingSelector = '[data-article-heading="true"], [data-article-content="true"] h1, [data-article-content="true"] h2, [data-article-content="true"] h3',
    minLevel = 1,
    maxLevel = 3,
  } = options
