...
export function MovieStatsPanel({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-slate-200/70 bg-white/72 p-5 shadow-[0_10px_28px_-24px_rgba(15,23,42,0.34)] backdrop-blur dark:border-0 dark:bg-[#17191c]/92 dark:shadow-none">
      <div
        aria-hidden="true"
