    ...
    <section className="rounded-[1.75rem] border border-slate-200/80 bg-white/72 p-5 shadow-[0_24px_56px_-36px_rgba(15,23,42,0.35)] backdrop-blur dark:border-[#2b2f36] dark:bg-[#17191c]/92 dark:shadow-[0_28px_56px_-34px_rgba(0,0,0,0.5)]">
      <div className="space-y-6">
        <div className="border-b border-slate-200/80 pb-5 dark:border-[#2b2f36]">
          <div className="text-[0.68rem] font-medium uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">
            {t('movies.stats.watchedCount')}
          </div>
          <div className="mt-3 text-5xl font-semibold leading-none tracking-[-0.04em] text-slate-950 dark:text-slate-50">
            {watchCount}
          </div>
        </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex flex-1 flex-col gap-1.5">
                    <button
                      ...
                      aria-label={t('movies.rating.value', { rating: item.rating })}
                    >
        ...
        <div className="border-t border-slate-200/80 pt-3 dark:border-[#2b2f36]">
          <div className="mb-3 text-[0.68rem] font-medium uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">
