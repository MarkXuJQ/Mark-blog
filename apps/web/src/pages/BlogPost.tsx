...
export function BlogPost() {
  ...
  if (!post) {
    return (
      <div className="mx-auto max-w-4xl">
        ...
        <Card className="border-0 shadow-[0_18px_42px_-32px_rgba(15,23,42,0.45)] dark:border-0">
  ...
  return (
    <div className="mx-auto w-full space-y-8">
      ...
      <Card className="border-0 p-6 shadow-[0_18px_42px_-32px_rgba(15,23,42,0.45)] dark:border-0">
        <DeferredComments
          key={commentPath}
          containerId="twikoo-container"
          path={commentPath}
...
const styles = {
  postCard:
    'block w-full border-0 shadow-[0_18px_42px_-32px_rgba(15,23,42,0.45)] transition-transform dark:border-0',
