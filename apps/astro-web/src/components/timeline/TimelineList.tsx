...
export function TimelineList({ events }: TimelineListProps) {
  const [expandedDates, setExpandedDates] = useState<string[]>(
    events.length > 0 ? [events[0].date] : [] // Expand the first one by default
  )
...
const styles = {
  ...
  // Event Header
  eventHeader: 'mb-4 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg p-2 -m-2',
